    ...
    <div> 
      {
        ...
        (<div className="max-w-[1200px] mx-auto flex flex-col md:flex-row justify-center">
          ...
          <div className="w-[100%] md:w-[40%] mt-5  flex flex-col">
            <div>
              <div className="flex flex-col gap-5 font-semibold text-xl text-green-700">Your Cart</div>
              <div className="font-semibold text-5xl text-green-700  -mt-0">Summary</div>
              <p className="text-xl">
            ...
            <div className="flex flex-col">
              <p className="text-gray-700 font-semibold">Total Amount: {totalAmount}</p>
